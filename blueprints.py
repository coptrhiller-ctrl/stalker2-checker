...
BLUEPRINTS_DATA = [
  ...
  {"id": "Blueprint_M701_Upgrade_2", "type": "weapon", "RU_Short": "M701 Super", "EN_Short": "M701 Super", "UA_Short": "M701 Super", "RU_Full": "M701 Super: Полимерная рукоятка", "EN_Full": "M701 Super: Polymer Handle", "UA_Full": "M701 Super: Полімерне руків'я", "RU_Desc": "Применение полимеров значительно снижает вес оружия.", "EN_Desc": "Polymers reduce overall weapon weight.", "UA_Desc": "Полімери значно знижують вагу зброї.", "teleport_cmd": "XTeleportTo 0 0 0"},
  ...
  {"id": "Blueprint_HeavyBattle_Spark_Armor_Upgrade_2", "type": "armor", "RU_Short": "ПСЗ-9И «Сокол»", "EN_Short": "PSZ-9I Falcon", "UA_Short": "ПСЗ-9І «Сокіл»", "RU_Full": "ПСЗ-9И «Сокол»: Свинцовый контейнер", "EN_Full": "PSZ-9I Falcon: Lead Container", "UA_Full": "ПСЗ-9І «Сокіл»: Свинцевий контейнер", "RU_Desc": "Защита от излучения артефактов.", "EN_Desc": "Lead container for radiation resistance.", "UA_Desc": "Захист від випромінювання артефактів.", "teleport_cmd": "XTeleportTo 0 0 0"},
  ...
  {"id": "Blueprint_SEVA_Neutral_Armor_Upgrade_2", "type": "armor", "RU_Short": "«СЕВА»", "EN_Short": "SEVA Suit", "UA_Short": "«СЕВА»", "RU_Full": "Комбинезон «СЕВА»: Экранирующее покрытие", "EN_Full": "SEVA Suit: Protective Coating", "UA_Full": "Комбінезон «СЕВА»: Екранувальне покриття", "RU_Desc": "Работает по принципу клетки Фарадея.", "EN_Desc": "Operates akin to a Faraday cage.", "UA_Desc": "Працює за принципом клітки Фарадея.", "teleport_cmd": "XTeleportTo 0 0 0"},
  ...
  {"id": "Blueprint_HeavyExoskeleton_Svoboda_Armor_Upgrade_4", "type": "armor", "RU_Short": "«Оплот»", "EN_Short": "Bulwark", "UA_Short": "«Оплот»", "RU_Full": "Экзокостюм «Оплот»: Свинцовый контейнер", "EN_Full": "Bulwark: Lead Container", "UA_Full": "Екзокостюм «Оплот»: Свинцевий контейнер", "RU_Desc": "Свинцовый отсек для артефакта.", "EN_Desc": "Lead container unit.", "UA_Desc": "Свинцевий контейнер.", "teleport_cmd": "XTeleportTo 0 0 0"},
