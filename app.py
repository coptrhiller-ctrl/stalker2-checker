...
# =========================================================================
# РАСПАКОВКА И ЧТЕНИЕ В ПАМЯТИ (LINUX / WINDOWS)
# =========================================================================
def decompress_sav(bytes_data):
    ...
    # Пытаемся подключить Linux или Windows декомпрессор
    try:
        for dll_name in ["./libooz.so", "./ooz_decompress.dll", "./oo2core_9_win64.dll"]:
...
st.markdown("Узнайте свой прогресс достижений **«Собиратель чудес»** (69 артов) и **«Все страньше и страньше»** без установки сторонних программ!")
...
if uploaded_file is not None:
    ...
    if raw_data is None:
        ...
        # Генерация TXT файла для скачивания
